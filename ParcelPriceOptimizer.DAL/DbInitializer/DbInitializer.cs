...
namespace ParcelPriceOptimizer.DAL.DbInitializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public DbInitializer(ApplicationDbContext db, ILogger<DbInitializer> logger, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _db = db;
            _logger = logger;
